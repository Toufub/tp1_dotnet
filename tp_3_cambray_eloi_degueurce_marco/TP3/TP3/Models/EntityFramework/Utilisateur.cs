...
public partial class Utilisateur
{
    ...
    [Column("utl_pwd")]
    [StringLength(64)]
    [RegularExpression(@"^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{6,10}$", ErrorMessage = "Le mot de passe doit contenir entre 6 et 10 caractères avec une majuscule une minuscule, un caractere spécial et un chiffre.")]
